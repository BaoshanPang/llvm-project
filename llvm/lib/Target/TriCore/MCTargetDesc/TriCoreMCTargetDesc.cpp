...
//  TargetRegistry::RegisterMCCodeGenInfo(TheTriCoreTarget, createTriCoreMCCodeGenInfo);
  ...
  TargetRegistry::RegisterMCInstrInfo(getTheTriCoreTarget(), createTriCoreMCInstrInfo);

  // Register the MC register info.
  TargetRegistry::RegisterMCRegInfo(getTheTriCoreTarget(), createTriCoreMCRegisterInfo);
  ...
  TargetRegistry::RegisterMCInstPrinter(getTheTriCoreTarget(), createTriCoreMCInstPrinter);

  // Register the ASM Backend.
  TargetRegistry::RegisterMCAsmBackend(getTheTriCoreTarget(), createTriCoreAsmBackend);

  // Register the MCCodeEmitter
  TargetRegistry::RegisterMCCodeEmitter(getTheTriCoreTarget(), createTriCoreMCCodeEmitter);
}
